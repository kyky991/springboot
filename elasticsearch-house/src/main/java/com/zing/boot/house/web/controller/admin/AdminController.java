package com.zing.boot.house.web.controller.admin;

import com.google.common.base.Strings;
import com.google.gson.Gson;
import com.qiniu.common.QiniuException;
import com.qiniu.http.Response;
import com.zing.boot.house.base.ApiDataTableResponse;
import com.zing.boot.house.base.ApiResponse;
import com.zing.boot.house.base.HouseOperation;
...
import com.zing.boot.house.web.dto.*;
...
public class AdminController {
    ...
    public ApiResponse uploadPhoto(@RequestParam("file") MultipartFile file) {
        ...
        File target = new File("D:/tmp/" + fileName);
        try {
