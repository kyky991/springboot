...
.desc {
	...
	<h1 class="page-title"> EasyVideo短视频后台管理系统 </h1>
	                ...
	                <div class="row">
	                    <div class="col-md-12">
	                        <div class="mt-widget-3" style="padding-top: 15px;">
	                        	...
	                        	<p class="desc">2、SpringBoot：2.0.5.RELEASE</p>
								<p class="desc">3、持久层框架：MyBatis 3.4.6 + pagehelper 5.1.4</p>
								<p class="desc">4、Mysql 5.1.46</p>
								<p class="desc">5、数据库连接池：阿里巴巴 Druid 1.1.10</p>
								<p class="desc">6、zookeeper：3.4.13</p>
								<p class="desc">7、spring-data-redis：1.8.15.RELEASE</p>
