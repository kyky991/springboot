...
<input type="hidden" id="apiServer" name="apiServer" value="http://192.168.0.3:8081"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.0.3:8080/mvc"/>
<!-- <input type="hidden" id="apiServer" name="apiServer" value="http://xxx.com/video-mini-api"/> -->
<!-- <input type="hidden" id="bgmServer" name="bgmServer" value="http://192.168.0.3/mvc"/> -->
